...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if(binding.etPassword.getText().toString().isEmpty()){
                    ...
                    return;
                          ...
                          //progress dialog command
                          progressDialog.show();

                         //authentication command for create user email and password
                        ...
                        //progress dialog dismiss command
        ...
        //adding command on already have account
        binding.tvAlreadyAcct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
